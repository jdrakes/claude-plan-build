...
The request is a question about why a wide value breaks the layout. The
answer is in src/format.py: every column is padded to its widest cell and
nothing is truncated. It asks for an explanation, not for a change.
